...
Since each row must contain exactly the specified number of stars, you may mark the remainder of a row once it has that many stars.

### 3. Column Complete

Since each column must contain exactly the specified number of stars, you may mark the remainder of a column once it has that many stars.

### 4. Region Complete

Since each region must contain exactly the specified number of stars, you may mark the remainder of a region once it has that many stars.

### 5. Forced Placement

When a row, column, or region has exactly as many unknown cells as stars still needed, all those unknown cells must contain stars.
